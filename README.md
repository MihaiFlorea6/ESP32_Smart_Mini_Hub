...
# Key Technologies
`ESP32 SoC`, `Embedded C++`, `Analog Sensors (LDR)`, `Power Electronics (BJT Transistors)`, `Finite State Machines (FSM)`, `Asynchronous Web Server`, `REST API`, `JavaScript (Fetch/AJAX)`, `HTML5/CSS3`.
